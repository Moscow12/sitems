...
// $data = "julio";
// $f_pointer =fopen("port.php", "r+");

// $contents = "";
// $content0 = "j";

// while ($content0 != "") {
// 	$content0 = fread($f_pointer, 8192);
//     $contents .= $content0;
// }
...
//while(tr){
sleep(2);
// $serial->sendMessage("
// done");
// sleep(1);
 ...
 while (($content0 = $serial->readPort()) !=1 ) {
 }
 echo "$content0";
 
 while (($content1 = $serial->readPort()) !=2) {
 }
 echo "$content1";

 sleep(5);
 $content3 = $serial->readPort();
 echo "$content3";

 $f_pointer =fopen("/var/www/html/Enroll Fingeprint/fingureprint/".$reg.".GIF", "w+");
 fwrite($f_pointer, $content3);
 //fflush($f_pointer);

 //echo "$content3";

 // $content0 =null;
 // while (($content0 = $serial->readPort())!=null) {
 // }
 // //$content0 = $serial->readPort();
 // echo "$content0";
...
// $content0 = 8;
// $content1 = null;
// //$f_pointer = $serial->_dHandle;
// $f_pointer =fopen($serial->_device, "w+");
// //fwrite($f_pointer, "julio nyakunga");
// //fflush($f_pointer);
